...
/* NOT:
 *
 * GeoJSON dosyalarını "kendimiz" (map.prototype.fetchMapData sırasında)
 * alıyoruz ve bunlar `PlotlyGeoAssets` adlı global bir nesnede saklanıyor
 * (topojson dosyaları `geo` alt grafiklerinde olduğu gibi).
 *
 * Harita, URL'leri geojson kaynakları olarak kullanmaya izin verir, ancak
 * özellik `id`'leri sayı olmayan özellikleri filtrelemeye izin vermez
 * (daha fazla bilgi: https://github.com/mapbox/mapbox-gl-js/issues/8088).
 */
